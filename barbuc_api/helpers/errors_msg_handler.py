...
class ReasonError(Enum):
    ...
    CREATE_BARBUCUE_ERROR = "An error has occured during barbucue creation, please try again"
    ...
    UPDATE_BARBUCUE_ERROR = "An error has occured during barbucue update, please try again"
